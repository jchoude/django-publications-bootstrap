# Generated by Django 2.0.3 on 2018-03-07 15:55
...
from publications_bootstrap.models import Publication as PubClass
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('month', echoices.fields.make_echoicefield(blank=True, echoices=PubClass.EMonths, null=True)),
        ...
        migrations.AddField(
            ...
            name='type',
            field=models.ForeignKey(db_index=False, on_delete=django.db.models.deletion.PROTECT, to='publications_bootstrap.Type'),
        ),
        migrations.AddField(
            model_name='catalog',
            name='publications',
